...
def create_app():
    ...
    def set_security_headers(response):
        ...
        csp_directives = [
            ...
            "connect-src 'self' https://challenges.cloudflare.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://static.cloudflareinsights.com https://v4.passwordless.dev",
